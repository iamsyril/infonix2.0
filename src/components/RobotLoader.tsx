...
const RobotLoader = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background transition-opacity duration-500 animate-fade-out" style={{ animationDelay: '2.8s', animationFillMode: 'forwards' }}>
      {/* Robot Container */}
